...
> available [Documentation](https://github.com/EvilBit-Labs/gold_digger/wiki).

Before you ask a question, it is best to search for existing [Issues](https://github.com/EvilBit-Labs/gold_digger/issues)
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  ...
  the [documentation](https://github.com/EvilBit-Labs/gold_digger/wiki). If you are looking for support, you might want
...
- Open an [Issue](https://github.com/EvilBit-Labs/gold_digger/issues/new). (Since we can't be sure at this point whether
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/EvilBit-Labs/gold_digger/wiki) carefully and find out if the functionality
  is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/EvilBit-Labs/gold_digger/issues) to see if the enhancement has already been
