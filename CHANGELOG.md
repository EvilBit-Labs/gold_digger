...
(Tech-debt cleanup work in progress on the `tech_debt_cleanup` branch.
The TLS migration narrative previously listed here belongs to v0.2.6 and
has been removed to avoid duplication. Add new user-facing changes here
as they land.)
